...
int main(){
    Case cases[] = {
        { impl__GetThisClass_CMFCPropertyGridToolTipCtrl__SAPEAUCRuntimeClass__XZ, impl__GetRuntimeClass_CMFCPropertyGridToolTipCtrl__UEBAPEAUCRuntimeClass__XZ, "CMFCPropertyGridToolTipCtrl", 280, 0xFFFF, &CWnd::classCWnd },
        { impl__GetThisClass_CMFCPropertySheetCategoryInfo__SAPEAUCRuntimeClass__XZ, impl__GetRuntimeClass_CMFCPropertySheetCategoryInfo__UEBAPEAUCRuntimeClass__XZ, "CMFCPropertySheetCategoryInfo", 168, 0xFFFF, &CObject::classCObject },
    };
