...
extern "C" void MS_ABI impl__OnDDXError_CDHtmlDialog__IEAAXPEB_WIH_Z(
    ...
    pThis->OnDDXError(lpszId, nErrorID, bSaveAndValidate);
}
...
extern "C" int MS_ABI impl__FindSinkForObject_CDHtmlDialog__IEAAHPEB_W_Z(
    ...
    return pThis->FindSinkForObject(lpszId);
}
...
extern "C" void MS_ABI impl__SetFocusToElement_CDHtmlDialog__IEAAXPEB_W_Z(
    CDHtmlDialog* pThis, const wchar_t* lpszId) {
    pThis->SetFocusToElement(lpszId);
}
...
extern "C" long MS_ABI impl__Select_FindString_CDHtmlDialog__IEAAJPEAUIHTMLSelectElement__PEA_WH_Z(
    ...
    return pThis->Select_FindString(pSelect, lpszFind, bExact);
}
...
extern "C" long MS_ABI impl__GetDropTarget_CDHtmlDialog__UEAAJPEAUIDropTarget__PEAPEAU2___Z(
...
extern "C" long MS_ABI impl__FilterDataObject_CDHtmlDialog__UEAAJPEAUIDataObject__PEAPEAU2___Z(
