// CMFCToolBarImages — OpenMFC implementation.
// Sources: gdicore.cpp, global_mfc-feature-9_impl.cpp

#define OPENMFC_APPCORE_IMPL

#include "detail/GdicoreSupport.h"
#include "detail/CMFCToolBarImagesSupport.h"
