#pragma once
// Shared internals of the former global_mfc_08_msgmap.cpp translation unit.
// Definitions live in detail/Mfc08MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace mfc08msgmap {} } }
using namespace openmfc::detail::mfc08msgmap;
...
namespace openmfc { namespace detail { namespace mfc08msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Mfc08Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace mfc08msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCTasksPaneFrameWnd();
} } }
namespace openmfc { namespace detail { namespace mfc08msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCTasksPaneToolBar();
} } }
namespace openmfc { namespace detail { namespace mfc08msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolTipCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc08msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCWindowsManagerDialog();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace mfc08msgmap {
extern const AFX_MSGMAP classCMFCTasksPaneFrameWnd_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc08msgmap {
extern const AFX_MSGMAP classCMFCTasksPaneToolBar_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc08msgmap {
extern const AFX_MSGMAP classCMFCToolTipCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc08msgmap {
extern const AFX_MSGMAP classCMFCWindowsManagerDialog_msgmap;
} } }
