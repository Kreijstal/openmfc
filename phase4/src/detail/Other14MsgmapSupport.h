#pragma once
// Shared internals of the former global_other_14_msgmap.cpp translation unit.
// Definitions live in detail/Other14MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace other14msgmap {} } }
using namespace openmfc::detail::other14msgmap;
...
namespace openmfc { namespace detail { namespace other14msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Other14Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace other14msgmap {
const AFX_MSGMAP* AFXAPI gbm_CVSListBoxBase();
} } }
namespace openmfc { namespace detail { namespace other14msgmap {
const AFX_MSGMAP* AFXAPI gbm_CVSListBoxEditCtrl();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace other14msgmap {
extern const AFX_MSGMAP classCVSListBoxBase_msgmap;
} } }
namespace openmfc { namespace detail { namespace other14msgmap {
extern const AFX_MSGMAP classCVSListBoxEditCtrl_msgmap;
} } }
