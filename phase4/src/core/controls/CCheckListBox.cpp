// CCheckListBox — OpenMFC implementation.
// Sources: ctrl_checklist.cpp

#define OPENMFC_APPCORE_IMPL

#include "detail/CCheckListBoxSupport.h"
...
extern "C" int MS_ABI impl__CheckFromPoint_CCheckListBox__IEAAHVCPoint__AEAH_Z(
    ...
    int nIndex = ListBoxItemFromPoint_CtrlChecklist(pThis->m_hWnd, pt);
