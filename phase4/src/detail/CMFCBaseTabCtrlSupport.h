#pragma once
// Shared internals of the former ctrl_mfcbasetabctrl_addtab.cpp translation unit.
// Definitions live in detail/CMFCBaseTabCtrlSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace cmfcbasetabctrl {} } }
using namespace openmfc::detail::cmfcbasetabctrl;
