#pragma once
// Shared internals of the former global_mfc_07_msgmap.cpp translation unit.
// Definitions live in detail/Mfc07MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace mfc07msgmap {} } }
using namespace openmfc::detail::mfc07msgmap;
...
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Mfc07Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCShadowWnd();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCShellListCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCShellTreeCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCSpinButtonCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCStandardColorsPropertyPage();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCStatusBar();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCTabCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCTasksPane();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCShadowWnd_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCShellListCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCShellTreeCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCSpinButtonCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCStandardColorsPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCStatusBar_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCTabCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc07msgmap {
extern const AFX_MSGMAP classCMFCTasksPane_msgmap;
} } }
