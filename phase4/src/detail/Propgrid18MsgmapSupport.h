#pragma once
// Shared internals of the former global_propgrid_18_msgmap.cpp translation unit.
// Definitions live in detail/Propgrid18MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace propgrid18msgmap {} } }
using namespace openmfc::detail::propgrid18msgmap;
...
namespace openmfc { namespace detail { namespace propgrid18msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Propgrid18Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace propgrid18msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCPropertyGridCtrl();
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCPropertyGridToolTipCtrl();
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCPropertyPage();
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCPropertySheet();
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCPropertySheetListBox();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace propgrid18msgmap {
extern const AFX_MSGMAP classCMFCPropertyGridCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
extern const AFX_MSGMAP classCMFCPropertyGridToolTipCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
extern const AFX_MSGMAP classCMFCPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
extern const AFX_MSGMAP classCMFCPropertySheet_msgmap;
} } }
namespace openmfc { namespace detail { namespace propgrid18msgmap {
extern const AFX_MSGMAP classCMFCPropertySheetListBox_msgmap;
} } }
