// CMFCOutlookBarPane — OpenMFC implementation.
// Sources: global_cmfcoutlookbarpane.cpp, manual_small_stub_implementations.cpp

#include "detail/CMFCOutlookBarPaneSupport.h"
