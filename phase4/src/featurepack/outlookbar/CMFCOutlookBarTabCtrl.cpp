// CMFCOutlookBarTabCtrl — OpenMFC implementation.
// Sources: global_cmfcoutlookbartabctrl.cpp, manual_small_stub_implementations.cpp, mfccore.cpp

#define OPENMFC_APPCORE_IMPL

#include "detail/CMFCOutlookBarTabCtrlSupport.h"
