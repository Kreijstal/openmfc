#pragma once
// Shared internals of the former global_toolbar_23_msgmap.cpp translation unit.
// Definitions live in detail/Toolbar23MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace toolbar23msgmap {} } }
using namespace openmfc::detail::toolbar23msgmap;
...
namespace openmfc { namespace detail { namespace toolbar23msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Toolbar23Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace toolbar23msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsOptionsPropertyPage();
} } }
namespace openmfc { namespace detail { namespace toolbar23msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsToolsPropertyPage();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace toolbar23msgmap {
extern const AFX_MSGMAP classCMFCToolBarsOptionsPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar23msgmap {
extern const AFX_MSGMAP classCMFCToolBarsToolsPropertyPage_msgmap;
} } }
