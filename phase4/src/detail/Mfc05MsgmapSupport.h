#pragma once
// Shared internals of the former global_mfc_05_msgmap.cpp translation unit.
// Definitions live in detail/Mfc05MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace mfc05msgmap {} } }
using namespace openmfc::detail::mfc05msgmap;
...
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Mfc05Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCLinkCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCListCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCMaskedEdit();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCMenuBar();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCMenuButton();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCMousePropertyPage();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCOutlookBar();
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCOutlookBarPane();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCLinkCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCListCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCMaskedEdit_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCMenuBar_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCMenuButton_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCMousePropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCOutlookBar_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc05msgmap {
extern const AFX_MSGMAP classCMFCOutlookBarPane_msgmap;
} } }
