// CMFCControlBarImpl — OpenMFC implementation.
// Sources: global_cmfccontrolbarimpl.cpp

#include "detail/CMFCControlBarImplSupport.h"
...
// Symbol: ??0CMFCControlBarImpl@@QEAA@PEAVCPane@@@Z
extern "C" void* MS_ABI impl___0CMFCControlBarImpl__QEAA_PEAVCPane___Z(void* pThis, void* pBar) {
    S_Cmfccontrolbarimpl* self = reinterpret_cast<S_Cmfccontrolbarimpl*>(pThis);
...
// CMFCControlBarImpl's MSVC-layout vtable: defined here, next to the
...
extern void* const g_CMFCControlBarImpl_vtbl[1] = {
    reinterpret_cast<void*>(&vdtor_Cmfccontrolbarimpl),
};
} } }
