#pragma once
// Shared internals of the former global_mfc_03_msgmap.cpp translation unit.
// Definitions live in detail/Mfc03MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace mfc03msgmap {} } }
using namespace openmfc::detail::mfc03msgmap;
...
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Mfc03Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCColorDialog();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCColorPickerCtrl();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCColorPopupMenu();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCColorPropertySheet();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCCustomColorsPropertyPage();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCDesktopAlertDialog();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCDesktopAlertWnd();
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCDropDownFrame();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCColorDialog_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCColorPickerCtrl_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCColorPopupMenu_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCColorPropertySheet_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCCustomColorsPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCDesktopAlertDialog_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCDesktopAlertWnd_msgmap;
} } }
namespace openmfc { namespace detail { namespace mfc03msgmap {
extern const AFX_MSGMAP classCMFCDropDownFrame_msgmap;
} } }
