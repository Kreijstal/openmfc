...
public:
    ...
    // Generated CWnd methods
    // Static methods
    static void CancelToolTips(int p0);
    static CObject* CreateObject();
    static void DeleteTempMap();
    static void* FromHandlePermanent(HWND p0);
    static const MSG* GetCurrentMessage();
    static void* GetDescendantWindow(HWND p0, int p1, int p2);
    static void* GetSafeOwner(void* p0, HWND* p1);
    static HWND GetSafeOwner_(void* p0, void** p1);
    static const AFX_INTERFACEMAP* GetThisInterfaceMap();
    static const AFX_MSGMAP* GetThisMessageMap();
    static int GrayCtlColor(HDC p0, HWND p1, UINT p2, HBRUSH p3, DWORD p4);
    static int ModifyStyle(HWND p0, DWORD p1, DWORD p2, UINT p3);
    static int ModifyStyleEx(HWND p0, DWORD p1, DWORD p2, UINT p3);
    static int ReflectLastMsg(HWND p0, LONGLONG* p1);
    ...
    virtual int ContinueModal();
    virtual long CreateAccessibleProxy(ULONGLONG p0, LONGLONG p1, LONGLONG* p2);
    virtual void EndModalLoop(int p0);
    virtual long EnsureStdObj();
    virtual long get_accChild(VARIANT p0, IDispatch** p1);
    virtual long get_accChildCount(long* p0);
    virtual long get_accDefaultAction(VARIANT p0, WCHAR** p1);
    virtual long get_accDescription(VARIANT p0, WCHAR** p1);
    virtual long get_accFocus(VARIANT* p0);
    virtual long get_accHelp(VARIANT p0, WCHAR** p1);
    virtual long get_accHelpTopic(WCHAR** p0, VARIANT p1, long* p2);
    virtual long get_accKeyboardShortcut(VARIANT p0, WCHAR** p1);
    virtual long get_accName(VARIANT p0, WCHAR** p1);
    virtual long get_accParent(IDispatch** p0);
    virtual long get_accRole(VARIANT p0, VARIANT* p1);
    virtual long get_accSelection(VARIANT* p0);
    virtual long get_accState(VARIANT p0, VARIANT* p1);
    virtual long get_accValue(VARIANT p0, WCHAR** p1);
    virtual CScrollBar* GetScrollBarCtrl(int p0) const;
    virtual void HtmlHelpW(ULONGLONG p0, UINT p1);
    virtual int IsFrameWnd() const;
    virtual int OnAmbientProperty(COleControlSite* p0, long p1, VARIANT* p2);
    virtual LONGLONG OnToolHitTest(CPoint p0, TOOLINFOW* p1) const;
    ...
    */
    ...
    int Attach(HWND p0);
    void AttachControlSite(CHandleMap* p0);
    void AttachControlSite(COleControlSite* p0, UINT p1);
    void BindDefaultProperty(long p0, WORD p1, const WCHAR* p2, void* p3);
    void BindProperty(long p0, void* p1);
    void CenterWindow(void* p0);
    void CheckDlgButton(int p0, UINT p1);
    void CheckRadioButton(int p0, int p1, int p2);
    void ClientToScreen(RECT* p0) const;
    int CreateControl(const GUID*& p0, const WCHAR* p1, DWORD p2, const RECT*& p3, void* p4, UINT p5, CFile* p6, int p7, WCHAR* p8);
    int CreateControl(const GUID*& p0, const WCHAR* p1, DWORD p2, const POINT* p3, const SIZE* p4, void* p5, UINT p6, CFile* p7, int p8, WCHAR* p9);
    int CreateControl(const CControlCreationInfo*& p0, DWORD p1, const POINT* p2, const SIZE* p3, void* p4, UINT p5);
    int CreateControl(const WCHAR* p0, const WCHAR* p1, DWORD p2, const RECT*& p3, void* p4, UINT p5, CFile* p6, int p7, WCHAR* p8);
    int CreateControlContainer(COleControlContainer** p0);
    int CreateControlSite(COleControlContainer* p0, COleControlSite** p1, UINT p2, const GUID*& p3);
    int CreateDlg(const WCHAR* p0, void* p1);
    int CreateDlgIndirect(const DLGTEMPLATE* p0, void* p1, HINSTANCE p2);
    int CreateRunDlgIndirect(const DLGTEMPLATE* p0, void* p1, HINSTANCE p2);
    LONGLONG Default();
    LONGLONG DefWindowProcW(UINT p0, ULONGLONG p1, LONGLONG p2);
    HWND Detach();
    int DoD2DPaint();
    void EnableScrollBarCtrl(int p0, int p1);
    int EnableToolTips(int p0);
    int EnableTrackingToolTips(int p0);
    int ExecuteDlgInit(void* p0);
    int ExecuteDlgInit(const WCHAR* p0);
    void FilterToolTipMessage(MSG* p0);
    void* FindSiteOrWnd(const COleControlSiteOrWnd* p0) const;
    void* FindSiteOrWndWithFocus() const;
    long GetAccessibilityHitTest(long p0, long p1, VARIANT* p2);
    long GetAccessibilityLocation(VARIANT p0, long* p1, long* p2, long* p3, long* p4);
    long GetAccessibleChild(VARIANT p0, IDispatch** p1);
    long GetAccessibleChildCount();
    long GetAccessibleName(VARIANT p0, WCHAR** p1);
    int GetCheckedRadioButton(int p0, int p1) const;
    COleControlContainer* GetControlContainer();
    IUnknown* GetControlUnknown();
    int GetDlgCtrlID() const;
    UINT GetDlgItemInt(int p0, int* p1, int p2) const;
    int GetDlgItemTextW(int p0, void*& p1, void** p2, void* p3) const;
    int GetDlgItemTextW(int p0, WCHAR* p1, int p2) const;
    ...
    COleControlSite* GetOleControlSite(UINT p0) const;
    CFrameWnd* GetParentFrame() const;
    void* GetParentOwner() const;
    COleControlSiteOrWnd* GetPrevDlgGroupItem(void* p0) const;
    void GetProperty(long p0, WORD p1, void* p2) const;
    CHwndRenderTarget* GetRenderTarget();
    DWORD GetStyle() const;
    void* GetSuperWndProcAddr();
    CFrameWnd* GetTopLevelFrame() const;
    void* GetTopLevelOwner() const;
    void* GetTopLevelParent() const;
    long GetWindowLessChildCount();
    int GetWindowPlacement(WINDOWPLACEMENT* p0) const;
    long GetWindowedChildCount();
    int HandleFloatingSysCommand(UINT p0, INT_PTR p1);
    int InitControlContainer(int p0);
    void InvokeHelper(long p0, WORD p1, void* p2, VARIANT* p3);
    UINT IsDlgButtonChecked(int p0) const;
    int IsTopParentActive() const;
    int IsTouchWindow() const;
    int MessageBoxW(const WCHAR* p0, const WCHAR* p1, UINT p2);
    LONGLONG OnActivateTopLevel(ULONGLONG p0, LONGLONG p1);
    int OnCharToItem(UINT p0, CListBox* p1, UINT p2);
    int OnChildNotify(UINT p0, ULONGLONG p1, LONGLONG p2, LONGLONG* p3);
    int OnCompareItem(int p0, COMPAREITEMSTRUCT* p1);
    HBRUSH OnCtlColor(CDC* p0, void* p1, UINT p2);
    int OnDeleteItem(int p0, DELETEITEMSTRUCT* p1);
    void OnDestroy();
    void OnDevModeChange(void* p0, const WCHAR* p1);
    void OnDisplayChange(UINT p0, int p1, int p2);
    LONGLONG OnDragList(ULONGLONG p0, LONGLONG p1);
    int OnDrawItem(int p0, DRAWITEMSTRUCT* p1);
    void OnEnterIdle(UINT p0, void* p1);
    void OnGesture(void* p0, ULONGLONG p1, LONGLONG p2);
    int OnGesturePan(void* p0, CPoint p1);
    int OnGesturePressAndTap(void* p0, CPoint p1, DWORD p2);
    int OnGestureRotate(void* p0, CPoint p1, DWORD p2);
    int OnGestureTwoFingerTap(void* p0, CPoint p1);
    int OnGestureZoom(void* p0, CPoint p1, DWORD p2);
    LONGLONG OnGetObject(ULONGLONG p0, LONGLONG p1);
    void OnHScroll(UINT p0, UINT p1, CScrollBar* p2);
    void OnHelp();
    void OnHelpFinder();
    void OnHelpIndex();
    ...
    int OnNcDestroy();
    void OnPaint();
    int OnParentNotify(UINT p0, LONGLONG p1);
    void OnSetFocus(void* p0);
    void OnSettingChange(UINT p0, const WCHAR* p1);
    void OnSysColorChange();
    LONGLONG OnTabletQuerySystemGestureStatus(ULONGLONG p0, LONGLONG p1);
    void OnTouchInput(ULONGLONG p0, ULONGLONG p1, TOUCHINPUT* p2, UINT p3);
    int OnTouchInputs(ULONGLONG p0, ULONGLONG p1, TOUCHINPUT* p2, UINT p3);
    ...
    void RemoveRadioCheckFromGroup(const CObject* p0);
    void RepositionBars(UINT p0, UINT p1, UINT p2, UINT p3, RECT* p4, RECT* p5, int p6);
    LONGLONG RunModalLoop(DWORD p0);
    void ScreenToClient(RECT* p0) const;
    void ScrollWindow(int p0, int p1, const RECT* p2, const RECT* p3);
    ...
    void SetScrollRange(int p0, int p1, int p2, int p3);
    int SetWindowPlacement(const WINDOWPLACEMENT* p0);
    int SubclassDlgItem(UINT p0, void* p1);
    int SubclassWindow(HWND p0);
    HWND UnsubclassWindow();
    int UpdateData(int p0);
    void UpdateDialogControls(void* p0, int p1);
    void EnableD2DSupport(int p0, int p1);
    void EnableDynamicLayout(int p0);
    CDCRenderTarget* GetDCRenderTarget();
    void InitDynamicLayout();
    int LoadDynamicLayoutResource(const WCHAR* p0);
    void ResizeDynamicLayout();
    int IsD2DSupportEnabled();
    void OnDrawIconicThumbnailOrLivePreview(CDC*& p0, CRect p1, CSize p2, int p3, int*& p4);
};
