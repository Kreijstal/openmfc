// Harvest the real mfc140u CMFCToolBarMenuButton vtable SLOT INDEX of each exported
...
// the base CMFCToolBarButton slots (0-52); new virtuals declared in CMFCToolBarMenuButton
// append after slot 52 in SDK-header (afxtoolbarmenubutton.h) declaration order.
// Build/run via tools/harvest/family/build_family_probe.sh.
#include <afxwin.h>
#include <afxcontrolbars.h>
#include <cstdio>
#include <cstdint>
#include "cmfctoolbarmenubutton_virt_ords.h"
int main(){
  ...
  const int N = 65;   // exact slot count (cmfctoolbarmenubutton_vtable.json); SetTearOff@64
