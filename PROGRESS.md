...
| **Real implementations** | 8,031 | 56.9% |
| ├─ Auto-generated thunks (`thunks.cpp`) | 0 | 0.0% |
| └─ Manual implementations (other units under `phase4/src/`) | 8,031 | 56.9% |
| **Skip list** (signature mismatch, return defaults) | 146 | 1.0% |
| **Remaining stubs** (return 0/nullptr/void) | 5,926 | 42.0% |
...
- **manual implementations**: Implemented directly under `phase4/src/` with `// Symbol:` comments — 8,031 symbols
...
- **stubs**: Generated by `gen_typed_stubs.py`, return 0/nullptr/void — 5,926 symbols
