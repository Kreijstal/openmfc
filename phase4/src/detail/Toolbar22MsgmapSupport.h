#pragma once
// Shared internals of the former global_toolbar_22_msgmap.cpp translation unit.
// Definitions live in detail/Toolbar22MsgmapSupport.cpp, so file-scope state keeps a
// single instance across the classes this unit was split into.
namespace openmfc { namespace detail { namespace toolbar22msgmap {} } }
using namespace openmfc::detail::toolbar22msgmap;
...
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP_ENTRY g_emptyMsgEntries_Toolbar22Msgmap[];
} } }
...
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarNameDialog();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsCommandsListBox();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsCommandsPropertyPage();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsCustomizeDialog();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsKeyboardPropertyPage();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsListCheckBox();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsListPropertyPage();
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
const AFX_MSGMAP* AFXAPI gbm_CMFCToolBarsMenuPropertyPage();
} } }

// The static maps. m_pfnGetBaseMap delegates to the base (or null at the root).
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarNameDialog_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsCommandsListBox_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsCommandsPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsCustomizeDialog_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsKeyboardPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsListCheckBox_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsListPropertyPage_msgmap;
} } }
namespace openmfc { namespace detail { namespace toolbar22msgmap {
extern const AFX_MSGMAP classCMFCToolBarsMenuPropertyPage_msgmap;
} } }
