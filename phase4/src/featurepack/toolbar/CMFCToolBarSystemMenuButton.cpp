...
extern "C" void* MS_ABI impl___1CMFCToolBarSystemMenuButton__UEAA_XZ() {
    return nullptr;
}

// Symbol: ?CopyFrom@CMFCToolBarSystemMenuButton@@UEAAXAEBVCMFCToolBarButton@@@Z
extern "C" void MS_ABI impl__CopyFrom_CMFCToolBarSystemMenuButton__UEAAXAEBVCMFCToolBarButton___Z(const void* /*class*/* p0) {}

// Symbol: ?CreateFromMenu@CMFCToolBarSystemMenuButton@@UEAAXPEAUHMENU__@@@Z
extern "C" void MS_ABI impl__CreateFromMenu_CMFCToolBarSystemMenuButton__UEAAXPEAUHMENU_____Z(void* /*struct*/* p0) {}

// Symbol: ?CreateMenu@CMFCToolBarSystemMenuButton@@UEBAPEAUHMENU__@@XZ
extern "C" void* MS_ABI impl__CreateMenu_CMFCToolBarSystemMenuButton__UEBAPEAUHMENU____XZ() {
    return nullptr;
}
...
extern "C" void MS_ABI impl__OnAfterCreatePopupMenu_CMFCToolBarSystemMenuButton__UEAAXXZ() {}

// Symbol: ?OnCalculateSize@CMFCToolBarSystemMenuButton@@UEAA?AUtagSIZE@@PEAVCDC@@AEBVCSize@@H@Z
extern "C" void* MS_ABI impl__OnCalculateSize_CMFCToolBarSystemMenuButton__UEAA_AUtagSIZE__PEAVCDC__AEBVCSize__H_Z(void* /*struct*/* p0, void* /*class*/* p1, const void* /*class*/* p2, int p3) {
    return nullptr;
}

// Symbol: ?OnCancelMode@CMFCToolBarSystemMenuButton@@UEAAXXZ
extern "C" void MS_ABI impl__OnCancelMode_CMFCToolBarSystemMenuButton__UEAAXXZ() {}

// Symbol: ?OnDblClk@CMFCToolBarSystemMenuButton@@UEAAXPEAVCWnd@@@Z
extern "C" void MS_ABI impl__OnDblClk_CMFCToolBarSystemMenuButton__UEAAXPEAVCWnd___Z(void* /*class*/* p0) {}

// Symbol: ?OnDraw@CMFCToolBarSystemMenuButton@@UEAAXPEAVCDC@@AEBVCRect@@PEAVCMFCToolBarImages@@HHHHH@Z
extern "C" void MS_ABI impl__OnDraw_CMFCToolBarSystemMenuButton__UEAAXPEAVCDC__AEBVCRect__PEAVCMFCToolBarImages__HHHHH_Z(void* /*class*/* p0, const void* /*class*/* p1, void* /*class*/* p2, int p3, int p4, int p5, int p6, int p7) {}
